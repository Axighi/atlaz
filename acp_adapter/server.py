...
try:
    from atlaz_cli import __version__ as HERMES_VERSION
except Exception:
...
class HermesACPAgent(acp.Agent):
    ...
    def _build_model_state(self, state: SessionState) -> SessionModelState | None:
        ...
        try:
            from atlaz_cli.models import curated_models_for_provider, normalize_provider, provider_label
    ...
    def _resolve_model_selection(raw_model: str, current_provider: str) -> tuple[str, str]:
        ...
        try:
            from atlaz_cli.models import detect_provider_for_model, parse_model_input
    ...
    async def _send_session_info_update(self, session_id: str) -> None:
        ...
        # atlaz_state.py schema — only started_at/ended_at). Use "now" as
