...
from atlaz_cli.nous_subscription import get_nous_subscription_features
...
_DOCS_BASE = "https://atlaz.nousresearch.com/docs"
...
from atlaz_cli.cli_output import (  # noqa: E402
    print_error,
    print_info,
    print_success,
    print_warning,
)
from atlaz_cli.secret_prompt import masked_secret_prompt  # noqa: E402
...
def prompt_checklist(title: str, items: list, pre_selected: list = None) -> list:
    ...
    from atlaz_cli.curses_ui import curses_checklist
...
def _print_setup_summary(config: dict, hermes_home):
    ...
    if subscription_features.image_gen.managed_by_nous:
        ...
        try:
            ...
            from atlaz_cli.plugins import _ensure_plugins_discovered
    ...
    try:
        ...
        from atlaz_cli.plugins import _ensure_plugins_discovered as _ensure_plugins
        _ensure_plugins()
        _video_backend = None
    ...
    if disabled_tools:
        ...
        from atlaz_constants import display_hermes_home as _dhh
...
def setup_model_provider(config: dict, *, quick: bool = False):
    ...
    from atlaz_cli.main import select_provider_and_model
    try:
    ...
    if not quick and _supports_same_provider_pool_setup(selected_provider):
        try:
            ...
            from atlaz_cli.auth_commands import auth_add_command
...
def _setup_slack():
    ...
    print()
    print_info("   Full guide: https://atlaz.nousresearch.com/docs/user-guide/messaging/slack/")
    print()
...
def _write_slack_manifest_and_instruct():
    ...
    """
    try:
<<<<<<< HEAD:atlaz_cli/setup.py
        from atlaz_cli.slack_cli import _build_full_manifest
        from hermes_constants import get_hermes_home
=======
        from hermes_cli.slack_cli import _build_full_manifest
        from atlaz_constants import get_hermes_home
>>>>>>> origin/main:hermes_cli/setup.py
...
def _setup_qqbot():
    ...
    from atlaz_cli.gateway import _setup_qqbot as _gateway_setup_qqbot
...
def _setup_webhooks():
    ...
    print()
    print_info("   Full guide: https://atlaz.nousresearch.com/docs/user-guide/messaging/webhooks/")
    print()
    ...
    print_info("   https://atlaz.nousresearch.com/docs/user-guide/messaging/webhooks/#configuring-routes")
    print()
...
def setup_gateway(config: dict):
    ...
    from atlaz_cli.gateway import _all_platforms, _platform_status, _configure_platform
...
def _model_section_has_credentials(config: dict) -> bool:
    ...
    Sources of truth:
      * ``PROVIDER_REGISTRY`` in ``atlaz_cli.auth`` — lists every supported
    ...
    """
    try:
        from atlaz_cli.auth import get_active_provider
...
def _get_section_config_summary(config: dict, section_key: str) -> Optional[str]:
    ...
    ``get_env_value`` is the module-level import from atlaz_cli.config
    ...
    if section_key == "model":
        ...
        from atlaz_cli.gateway import _all_platforms, _platform_status
...
def run_setup_wizard(args):
    ...
    """
    from atlaz_cli.config import is_managed, managed_error
    if is_managed():
