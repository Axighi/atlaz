...
from atlaz_cli.dashboard_auth.base import ProviderError
from atlaz_cli.dashboard_auth.cookies import read_session_cookies
from atlaz_cli.dashboard_auth.public_paths import PUBLIC_API_PATHS
...
async def gated_auth_middleware(
    ...
    if session is None:
        ...
        from atlaz_cli.dashboard_auth.cookies import clear_session_cookies
        from atlaz_cli.dashboard_auth.prefix import prefix_from_request
