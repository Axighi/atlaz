...
from atlaz_cli import kanban_swarm as ks
from atlaz_cli.profiles import get_active_profile_name, get_profile_dir, seed_profile_skills
...
def build_parser(parent_subparsers: argparse._SubParsersAction) -> argparse.ArgumentParser:
    ...
    kanban_parser = parent_subparsers.add_parser(
        ...
        description=(
            ...
            "See https://atlaz.nousresearch.com/docs/user-guide/features/kanban "
...
def _cmd_specify(args: argparse.Namespace) -> int:
    ...
    from atlaz_cli import kanban_specify as spec
...
def _cmd_decompose(args: argparse.Namespace) -> int:
    ...
    from atlaz_cli import kanban_decompose as decomp
