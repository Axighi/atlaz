...
def _prompt_plugin_env_vars(manifest: dict, console) -> None:
    ...
    from atlaz_cli.config import get_env_value, save_env_value  # noqa: F811
...
def cmd_update(name: str) -> None:
    ...
    if "Already up to date" in out:
        ...
        console.print(f"[dim]{out}[/di

... [OUTPUT TRUNCATED - 11682 chars omitted out of 61682 total] ...

r plugin discovery helpers
# ---------------------------------------------------------------------------
...
def _discover_context_engines() -> list[tuple[str, str]]:
    ...
    try:
        from atlaz_cli.plugins import discover_plugins, get_plugin_context_engine
        discover_plugins()
