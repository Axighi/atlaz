...
from atlaz_cli import __version__ as VERSION, __release_date__ as RELEASE_DATE
...
_UPSTREAM_REPO_URL = "https://github.com/Axighi/atlaz.git"
...
def get_git_banner_state(repo_dir: Optional[Path] = None) -> Optional[dict]:
    ...
    ``atlaz_cli/build_info.py``) and return it as a frozen
    ...
    if repo_dir is None:
        ...
        try:
            from atlaz_cli.build_info import get_build_sha
...
_RELEASE_URL_BASE = "https://github.com/Axighi/atlaz/releases/tag"
...
def build_welcome_banner(console: Console, model: str, cwd: str,
    ...
    try:
        from atlaz_cli.codex_runtime_switch import get_current_runtime
        from atlaz_cli.config import load_config as _load_cfg
    ...
    try:
        ...
        if behind is not None and behind != 0:
            from atlaz_cli.config import get_managed_update_command, recommended_update_command
            if behind > 0:
