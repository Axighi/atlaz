...
from atlaz_cli.default_soul import DEFAULT_SOUL_MD
...
# atlaz_cli/main.py; lives here so the wording stays consistent and we
...
DEFAULT_CONFIG = {
    ...
    "security": {
        ...
        # ``atlaz_cli/security_advisories.py`` for the catalog.
        "acked_advisories": [],
...
def get_custom_provider_context_length(
    ...
    used by:
      ...
      * ``atlaz_cli.model_switch.resolve_display_context_length`` (``/model`` confirmation display)
