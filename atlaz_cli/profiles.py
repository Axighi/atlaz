...
_PROFILE_DIRS = [
    ...
    # See atlaz_constants.get_subprocess_home() and issue #4426.
    "home",
]
...
def _maybe_register_gateway_service(profile_name: str) -> None:
    ...
    try:
        ...
        from atlaz_cli.service_manager import get_service_manager
...
def _cleanup_gateway_service(name: str, profile_dir: Path) -> None:
    ...
    try:
        ...
        from atlaz_cli.gateway import get_service_name, get_launchd_plist_path
