...
| | |
|---|---|
| Source | Optional — install with `atlaz skills install official/finance/3-statement-model` |
...
See [references/formulas.md](https://github.com/Axighi/atlaz/blob/main/optional-skills/finance/3-statement-model/references/formulas.md) for all formula details.
