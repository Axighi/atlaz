...
| | |
|---|---|
| Source | Optional — install with `atlaz skills install official/productivity/canvas` |
...
4. Name the token (e.g., "ATLAZ"), set an optional expiry, and click **Generate Token**
