...
| | |
|---|---|
| Source | Optional — install with `atlaz skills install official/creative/kanban-video-orchestrator` |
...
3. Creates each Hermes profile via `atlaz profile create --clone`
...
7. Fires the initial `atlaz kanban create` task assigned to the director

Use `scripts/bootstrap_pipeline.py` to generate setup.sh from a brief +
team-design JSON. See **[references/kanban-setup.md](https://github.com/Axighi/atlaz/blob/main/optional-skills/creative/kanban-video-orchestrator/references/kanban-setup.md)**
...
playbook, see **[references/monitoring.md](https://github.com/Axighi/atlaz/blob/main/optional-skills/creative/kanban-video-orchestrator/references/monitoring.md)**.
...
task graphs. See **[references/examples.md](https://github.com/Axighi/atlaz/blob/main/optional-skills/creative/kanban-video-orchestrator/references/examples.md)**.
...
6. **The director never executes.** Even with the full `kanban + terminal +
   ...
   a `atlaz kanban create` call to a specialist profile. The
