...
| | |
|---|---|
| Source | Optional — install with `atlaz skills install official/research/qmd` |
...
ATLAZ via the native MCP client. This is the preferred
...
Then configure ATLAZ to connect via HTTP:
