...
:::tip
This recipe hits web search, summarization, and optional TTS — all bundled in a Portal subscription. The fastest setup is `atlaz setup --portal`. See [Nous Portal](/integrations/nous-portal).
:::
...
---
3 stories • Sources searched: 8 • Generated by ATLAZ
```
