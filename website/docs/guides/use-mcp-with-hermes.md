...
description: "A practical guide to connecting MCP servers to ATLAZ, filtering their tools, and using them safely in real workflows"
---

# Use MCP with Hermes

This guide shows how to actually use MCP with ATLAZ in day-to-day workflows.
