...
description: "Step-by-step guide to running ATLAZ entirely on your own machine with Ollama and open-weight models like Gemma 4, no cloud API keys or paid subscriptions needed"
---
