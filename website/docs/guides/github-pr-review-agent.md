...
┌───────────────────────────────────────────────────────────────────┐
│                                                                   │
│   Cron Timer  ──▶  ATLAZ  ──▶  GitHub API  ──▶  Review     │
...
- **ATLAZ installed** — see the [Installation guide](/getting-started/installation)
...
Verify it loaded — start `atlaz` and you should see `code-review` in the skills list at startup.
