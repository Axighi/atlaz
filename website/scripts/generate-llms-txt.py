...
Both publish at:
  https://atlaz.nousresearch.com/docs/llms.txt
  https://atlaz.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://atlaz.nousresearch.com/docs"
...
def emit_llms_index() -> str:
    ...
    lines.append("")
    lines.append("Repo: https://github.com/Axighi/atlaz")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    chunks: list[str] = [
        ...
        "Canonical site: https://atlaz.nousresearch.com/docs\n",
        "Short index: https://atlaz.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
