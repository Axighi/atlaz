...
$HERMES_OSINT_CACHE/icij/ (default: ~/.cache/atlaz-osint/icij/) and search
...
def _cache_dir() -> Path:
    ...
    return Path.home() / ".cache" / "atlaz-osint" / "icij"
...
def main() -> int:
    ...
    p.add_argument(
        ...
        type=Path,
        default=None,
        help="Override cache directory (default: $HERMES_OSINT_CACHE/icij or ~/.cache/atlaz-osint/icij)",
    )
    p.add_argument(
        "--force-refresh",
        action="store_true",
