"""Tests for the secret-source tracking in ``atlaz_cli.env_loader``.
...
from atlaz_cli import env_loader  # noqa: E402
...
def test_apply_external_secret_sources_dedupes_within_process(tmp_path, monkeypatch):
    ...
    hot modules (cli.py, atlaz_cli/main.py, run_agent.py, ...).  The
    ...
    # cli.py, atlaz_cli/main.py, run_agent.py, trajectory_compressor.py,
