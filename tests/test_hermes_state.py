"""Tests for atlaz_state.py — SessionDB SQLite CRUD, FTS5 search, export."""
...
class TestSchemaInit:
    ...
    def test_schema_version(self, db):
        from atlaz_state import SCHEMA_VERSION
    ...
    def test_schema_sql_is_source_of_truth(self, db):
        ...
        """
        from atlaz_state import SCHEMA_SQL
...
class TestConcurrentWriteSafety:
    ...
    def test_sqlite_timeout_is_at_least_30s(self, db):
        ...
        import inspect
        from atlaz_state import SessionDB as _SessionDB
