"""Tests for the kanban CLI surface (atlaz_cli.kanban)."""
...
from atlaz_cli import kanban as kc
...
def test_kanban_in_autocomplete_table():
    from atlaz_cli.commands import COMMANDS, SUBCOMMANDS
...
def test_kanban_not_gateway_only():
    ...
    from atlaz_cli.commands import COMMAND_REGISTRY
