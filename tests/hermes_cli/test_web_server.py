"""Tests for atlaz_cli.web_server and related config utilities."""
...
class TestWebServerEndpoints:
    ...
    def _setup_test_client(self, monkeypatch, _isolate_hermes_home):
        ...
        from atlaz_cli.web_server import app, _SESSION_HEADER_NAME, _SESSION_TOKEN

        monkeypatch.setattr(atlaz_state, "DEFAULT_DB_PATH", get_hermes_home() / "state.db")
    ...
    def test_get_status_filters_unconfigured_gateway_platforms(self, monkeypatch):
        ...
        import atlaz_cli.web_server as web_server
    ...
    def test_reveal_env_var(self, tmp_path):
        ...
        from atlaz_cli.web_server import _SESSION_HEADER_NAME, _SESSION_TOKEN
    ...
    def test_reveal_env_var_no_token(self, tmp_path):
        ...
        from starlette.testclient import TestClient
        from atlaz_cli.web_server import app
        from atlaz_cli.config import save_env_value
    ...
    def test_reveal_env_var_bad_token(self, tmp_path):
        ...
        from atlaz_cli.config import save_env_value
        from atlaz_cli.web_server import _SESSION_HEADER_NAME
    ...
    def test_reveal_env_var_legacy_authorization_header_still_works(self, tmp_path):
        ...
        from atlaz_cli.config import save_env_value
        from atlaz_cli.web_server import _SESSION_TOKEN
    ...
    def test_path_traversal_dotdot_blocked(self):
        ...
        resp = self.client.get("/%2e%2e/atlaz_cli/web_server.py")
        assert resp.status_code in {200, 404}
        if resp.status_code == 200:
...
class TestBuildSchemaFromConfig:
    def test_produces_expected_field_count(self):
        from atlaz_cli.web_server import CONFIG_SCHEMA
    ...
    def test_empty_prefix_produces_correct_keys(self):
        from atlaz_cli.web_server import _build_schema_from_config
...
class TestNewEndpoints:
    ...
    def test_profiles_list_falls_back_when_profile_listing_fails(self, monkeypatch):
        from atlaz_constants import get_hermes_home
        import atlaz_cli.profiles as profiles_mod
    ...
    def test_skills_list_includes_disabled_skills(self, monkeypatch):
        ...
        import atlaz_cli.skills_config as skills_config
        import atlaz_cli.web_server as web_server
    ...
    def test_toolsets_list_matches_cli_enabled_state(self, monkeypatch):
        import atlaz_cli.tools_config as tools_config
...
class TestModelContextLength:
    ...
    def test_normalize_extracts_context_length_from_dict(self):
        ...
        from atlaz_cli.web_server import _normalize_config_for_web
    ...
    def test_denormalize_writes_context_length_into_model_dict(self):
        ...
        from atlaz_cli.web_server import _denormalize_config_from_web
...
class TestModelInfoEndpoint:
    ...
    def test_model_info_with_dict_config(self, monkeypatch):
        import atlaz_cli.web_server as ws
...
class TestNormaliseThemeDefinition:
    ...
    def test_rejects_missing_name(self):
        from atlaz_cli.web_server import _normalise_theme_definition
...
class TestDiscoverUserThemes:
    ...
    def test_returns_empty_when_dir_missing(self, tmp_path, monkeypatch):
        ...
        from atlaz_cli import web_server
...
class TestPtyWebSocket:
    ...
    def test_unavailable_platform_closes_with_message(self, monkeypatch):
        from atlaz_cli.pty_bridge import PtyUnavailableError
        ...
        import atlaz_cli.web_server as ws_mod
    ...
    def test_pub_broadcasts_to_events_subscribers(self, monkeypatch):
        ...
        import time
        from urllib.parse import urlencode
        from atlaz_cli import web_server as ws_mod
