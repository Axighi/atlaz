"""Tests for atlaz_cli/completion.py — shell completion script generation."""
...
from atlaz_cli.completion import _walk, generate_bash, generate_zsh, generate_fish
...
class TestSubcommandDrift:
    def test_SUBCOMMANDS_covers_required_commands(self):
        ...
        """
        import inspect
        from atlaz_cli.main import _coalesce_session_name_args
