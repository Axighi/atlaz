...
from atlaz_cli.main import _cmd_update_check, cmd_update


# ---------- cmd_update (apply path) ----------


@patch("atlaz_cli.config.is_managed", return_value=False)
@patch("atlaz_cli.config.detect_install_method", return_value="docker")
