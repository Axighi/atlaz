"""Tests for atlaz_cli.security_advisories.
...
import atlaz_cli.security_advisories as adv
...
class TestAck:
    ...
    def test_ack_advisory_persists_id(self, isolated_home, monkeypatch):
        ...
        # don't depend on the full atlaz_cli.config bootstrap.
        store: dict = {"security": {}}
        monkeypatch.setattr(
            "atlaz_cli.config.load_config", lambda: store
        )
        monkeypatch.setattr(
            "atlaz_cli.config.save_config",
