...
``tests/atlaz_cli/test_plugin_scanner_recursion.py::TestRegisterImageGenProvider``.
"""
...
class TestRegisterTTSProvider:
    ...
    def test_accepts_valid_provider(self):
        ...
        atlaz_home = Path(os.environ["HERMES_HOME"])
        _write_plugin(
            atlaz_home / "plugins",
            "my-tts-plugin",
            register_body=(
        ...
        _enable(atlaz_home, "my-tts-plugin")
    ...
    def test_rejects_non_provider(self, caplog):
        ...
        _enable(atlaz_home, "bad-tts-plugin")
    ...
    def test_rejects_builtin_shadow(self, caplog):
        ...
        _enable(atlaz_home, "shadow-tts-plugin")
