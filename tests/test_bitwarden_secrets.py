...
def hermes_home(tmp_path, monkeypatch):
    ...
    if hasattr(atlaz_constants, "_HERMES_HOME_CACHE"):
        atlaz_constants._HERMES_HOME_CACHE = None  # type: ignore[attr-defined]
    return home
...
def test_env_loader_skips_when_disabled(tmp_path, monkeypatch):
    ...
    from atlaz_cli.env_loader import _apply_external_secret_sources
