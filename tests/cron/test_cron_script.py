...
def cron_env(tmp_path, monkeypatch):
    ...
    (atlaz_home / "scripts").mkdir()
    monkeypatch.setenv("HERMES_HOME", str(atlaz_home))

    # Clear cached module-level paths
    import cron.jobs as jobs_mod
    monkeypatch.setattr(jobs_mod, "HERMES_DIR", atlaz_home)
    monkeypatch.setattr(jobs_mod, "CRON_DIR", atlaz_home / "cron")
    monkeypatch.setattr(jobs_mod, "JOBS_FILE", atlaz_home / "cron" / "jobs.json")
    monkeypatch.setattr(jobs_mod, "OUTPUT_DIR", atlaz_home / "cron" / "output")
