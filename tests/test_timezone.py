"""
Tests for timezone support (atlaz_time module + integration points).
...
def _reset_hermes_time_cache():
    """Reset the atlaz_time module cache (replacement for removed reset_cache)."""
    atlaz_time._cached_tz = None
    atlaz_time._cached_tz_name = None
    atlaz_time._cache_resolved = False


# =========================================================================
# atlaz_time.now() — core helper
# =========================================================================
...
class TestHermesTimeNow:
    ...
    def test_invalid_timezone_falls_back(self, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="atlaz_time"):
            result = atlaz_time.now()
