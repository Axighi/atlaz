...
from atlaz_constants import get_hermes_home, get_skills_dir, is_wsl
...
def build_skills_system_prompt(
    ...
    if not skills_by_category:
        ...
        result = (
            ...
            "first. It has the actual commands (e.g. `hermes config set …`, `atlaz tools`, "
            "`atlaz setup`) so you don't have to guess or invent workarounds.\n"
...
def load_soul_md() -> Optional[str]:
    ...
    """
    try:
        from atlaz_cli.config import ensure_hermes_home
        ensure_hermes_home()
    except Exception as e:
